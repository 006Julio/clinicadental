...
-- Base de datos para Clínica Dental - Usuarios
-- --------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `password` varchar(255) NOT NULL,  -- En producción usa password_hash()
...
-- ¡EN PRODUCCIÓN USA CONTRASEÑAS ENCRIPTADAS!
-- --------------------------------------------------------
...
-- --------------------------------------------------------
SELECT '✅ Base de datos y usuarios creados correctamente.' as 'STATUS';